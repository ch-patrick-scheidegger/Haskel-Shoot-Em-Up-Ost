...
-- of the first one hundred integer squares. You may use the funciton sum :: [Int] -> Int in your definition.
...
-- > replicate 3 True 
-- [True,True,True]
-- Note: If you are trying this within ghc, please note that replicate is already defined in the Prelude. 
-- Use the name myReplicate which is currently undefined instead.
